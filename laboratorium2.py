...
# id = int(input('Podaj indeks osoby od 0 do 9: '))
# imie = input('Podaj ile takich imion jest na liście, wpisz imie:  ')

# l = ['Ala', 'Ola', 'Kasia', 'Basia', 'Tomek','Olek','Ala','Krzysztof','Zuzia', 'Piotr']
# print(l[id])
